...
import { getEntities as getGames } from 'app/entities/game/game/game.reducer';
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="scrabblecompanionApp.gamePlayer.home.createOrEditLabel">Create or edit a Player</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
