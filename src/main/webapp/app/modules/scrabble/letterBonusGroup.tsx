    ...
    return (
      <div className="boxAndGroup">
        <div className="radioGroup">
          <Button onClick={() => this.handleBonusChange(2)} active={this.props.bonus === 2} size="sm" disabled={this.props.disabled}>
            2x
          </Button>
          <Button onClick={() => this.handleBonusChange(3)} active={this.props.bonus === 3} size="sm" disabled={this.props.disabled}>
            3x
          </Button>
          <Button onClick={() => this.handleBonusChange(0)} active={this.props.bonus === 0} disabled={this.props.disabled}>
            Blank
          </Button>
        </div>
